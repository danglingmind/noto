...
export const metadata: Metadata = {
	title: 'Terms of Service — Convoy',
	description: 'Terms of service for the Convoy iOS app.',
}

export default function ConvoyTermsPage() {
	return (
				...
				<div className="space-y-10 text-sm leading-relaxed">
					...
					<section>
						...
						<p className="text-[#1A1A1A]">
							By downloading, installing, or using the Convoy iOS application (&quot;the App&quot;), you agree to be bound by these Terms of Service (&quot;Terms&quot;). If you do not agree, do not use the App. These Terms apply to all users of Convoy.
						</p>
					</section>

					<section>
						<h2 className="text-base font-normal flex items-center gap-2 mb-3">
							<FileText className="h-4 w-4" /> What Convoy Is
						</h2>
						<p className="text-[#1A1A1A]">
							Convoy is a group ride coordination app. It enables groups of riders to share their real-time location with each other, follow a shared route, and coordinate rides via invite codes. Convoy is a coordination tool only — it is not a taxi, rideshare, or transportation service. We do not employ drivers, operate vehicles, or arrange transportation.
						</p>
					</section>
					...
					<section>
						...
						<ul className="space-y-2 text-[#1A1A1A]">
							{[
								'You must be at least 17 years old to use Convoy.',
					...
					<section>
						...
						<ul className="space-y-2 text-[#1A1A1A] mb-4">
							{[
								...
								'Use Convoy only for lawful group riding coordination.',
							].map((item) => (
								<li key={item} className="flex items-start gap-2">
									<span className="mt-1.5 h-1.5 w-1.5 rounded-full flex-shrink-0 bg-[#6B6B6B]"></span>
									{item}
					...
					<section>
						...
						<ul className="space-y-2 text-[#1A1A1A]">
							{[
								'Convoy offers optional membership plans purchased through Apple\'s in-app purchase system.',
					...
					<section>
						...
						<p className="text-[#1A1A1A]">
							Convoy is provided &quot;as is&quot; without warranties of any kind. We do not guarantee the accuracy of location data, route information, or navigation directions. Convoy is a coordination aid — always exercise your own judgment while riding. We are not responsible for accidents, injuries, or damages arising from use of the App.
						</p>
					</section>
					...
					<section>
						...
						<p className="text-[#1A1A1A]">
							To the maximum extent permitted by law, The Studio Meraki shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of Convoy, including but not limited to damages for personal injury, property damage, or data loss.
						</p>
					</section>
					...
					<section>
						...
						<p className="text-[#1A1A1A]">
							We may update these Terms at any time. The latest version is always available at <strong>vynl.in/convoy/terms</strong>. Continued use of the App after changes constitutes acceptance of the updated Terms.
						</p>
					</section>
